...
from app.planner import PlannerContext, PlannerRuleEngine, PlannerSegment
...
def main() -> None:
    ...
    hints = engine.build_hints(context=context, segments=segments)
    ...
    print("\ncount:", len(hints))
    print("DONE: Planner rule engine test completed.")
